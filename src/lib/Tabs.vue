<template>
<div class="ideal-tabs">
  <div class="ideal-tabs-nav" ref="container">
    <div class="ideal-tabs-nav-item" v-for="(t,index) in titles" :ref="el => { if (t===selected) selectedItem = el }" @click="select(t)" :class="{selected: t=== selected}" :key="index">{{t}}</div>
    <div class="ideal-tabs-nav-indicator" ref="indicator"></div>
  </div>
  <div class="ideal-tabs-content">
